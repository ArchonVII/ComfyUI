...
def score(graph, mode, pos):
    return add(graph, "DualIdentityScore", "IDENTITY_LAB_SCORE", pos, (("base_image", "IMAGE"), ("reference_image", "IMAGE"), ("generated_image", "IMAGE"), ("experiment_id", "STRING"), ("run_id", "STRING"), ("extra_metadata", "EXTRA_METADATA"), ("experiment_mode", "COMBO"), ("face_score_threshold", "FLOAT"), ("same_identity_threshold", "FLOAT"), ("face_selection", "COMBO"), ("write_manifest", "BOOLEAN"), ("manifest_dir", "STRING"), ("run_label", "STRING"), ("metadata_key", "STRING")), (("reference_cosine_similarity", "FLOAT"), ("reference_detected", "BOOLEAN"), ("reference_same_identity", "BOOLEAN"), ("base_cosine_similarity", "FLOAT"), ("base_detected", "BOOLEAN"), ("base_same_identity", "BOOLEAN"), ("generated_detected", "BOOLEAN"), ("active_cosine_similarity", "FLOAT"), ("active_same_identity", "BOOLEAN"), ("rankable", "BOOLEAN"), ("report_json", "STRING"), ("extra_metadata", "EXTRA_METADATA")), (mode, 0.7, 0.363, "largest", True, "default/identity_score_runs", f"identity-lab-{mode}", "identity_score_report"), (420, 390))
